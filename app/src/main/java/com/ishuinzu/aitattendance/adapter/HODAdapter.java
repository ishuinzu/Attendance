...
public class HODAdapter extends RecyclerView.Adapter<HODAdapter.ViewHolder> {
    ...
    public HODAdapter(Context context, List<HOD> hods, LayoutInflater layoutInflater) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(layoutInflater.inflate(R.layout.item_hod, parent, false));
    }

    @SuppressLint("UseCompatLoadingForDrawables")
    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        if (hods.get(position).getIs_verified()) {
        ...
        holder.cardProfile.setOnClickListener(view -> context.startActivity(new Intent(context, UpdateHODActivity.class).putExtra("ID", hods.get(position).getId()).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)));
        holder.btnUpdate.setOnClickListener(view -> context.startActivity(new Intent(context, UpdateHODActivity.class).putExtra("ID", hods.get(position).getId()).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)));
        holder.btnDelete.setOnClickListener(view -> {
            ...
            (dialog.findViewById(R.id.btnDelete)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    // Delete HOD Profile
                    FirebaseAuth.getInstance().signInWithEmailAndPassword(hods.get(position).getEmail(), hods.get(position).getPassword())
        ...
        holder.txtName.setText(hods.get(position).getName());
        holder.txtDepartment.setText(hods.get(position).getDepartment());
        GlideApp.with(context).load(hods.get(position).getImg_link()).error(R.drawable.img_logo_rounded).into(holder.imgProfile);
    }
